...
export default function ContactPage() {
  return (
    <div className="content">
      ...
      <section style={{ padding: "var(--space-5xl) var(--space-3xl)" }}>
        <div style={{ maxWidth: "1400px", margin: "0 auto", display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: "var(--space-5xl)" }}>
          ...
          <div>
            ...
            <a href="mailto:enquiries@lexiglobalfirm.com" className="btn btn-primary" style={{ display: "inline-block", fontSize: "1rem", padding: "var(--space-lg) var(--space-3xl)", marginBottom: "var(--space-xl)" }}>
              enquiries@lexiglobalfirm.com
            </a>
            <p style={{ color: "var(--color-text-tertiary)", fontSize: ".875rem", lineHeight: "1.7", marginBottom: "var(--space-4xl)" }}>
