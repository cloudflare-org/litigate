...
export default function CaseSinglePage() {
    ...
    return (
        <div className="content">
            ...
            {!item ? (
                <div style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "var(--space-xl)", paddingTop: "120px", padding: "120px var(--space-lg) var(--space-3xl)" }}>
                    ...
                    <section className="page-section-alt">
                        <div className="page-section-inner">
                            ...
                            <div className="related-grid">
                                {related.map((r) => (
                                    <Link key={r.slug} href={`/cases/${r.slug}`} className="related-card">
